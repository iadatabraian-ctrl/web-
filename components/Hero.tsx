...
export function Hero() {
  return (
    <section id="inicio" className="relative overflow-hidden bg-brand-black px-5 pb-6 pt-6 sm:px-8 sm:pb-16 sm:pt-16">
      ...
      <div className="relative mx-auto flex min-h-[calc(100dvh-6.5rem)] max-w-6xl flex-col justify-center lg:block lg:min-h-0">
        <div className="grid gap-6 lg:grid-cols-[1.15fr_0.85fr] lg:items-center lg:gap-8">
          <div>
            ...
            <h1 className="mt-5 font-display text-[9vw] leading-[1.05] tracking-tight sm:mt-4 sm:text-6xl sm:leading-[0.98] lg:text-[4.6rem]">
            ...
            <p className="mt-5 max-w-xl font-body text-[13px] leading-relaxed text-brand-ink-on-black-soft sm:mt-6 sm:text-lg">
            ...
            <div className="mt-5 flex items-center gap-2 sm:mt-6 lg:flex hidden">
        ...
        <div className="mt-7 grid grid-cols-4 gap-2 sm:mt-16 sm:gap-6">
