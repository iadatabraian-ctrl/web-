      ...
      <div className="mx-auto max-w-6xl">
        <div className="grid gap-6 lg:grid-cols-[1.15fr_0.85fr] lg:items-center lg:gap-8">
          <div>
            ...
            <h1 className="mt-3 font-display text-[9vw] leading-[1.03] tracking-tight sm:mt-4 sm:text-6xl sm:leading-[0.98] lg:text-[4.6rem]">
            ...
            <p className="mt-3 max-w-xl font-body text-[13px] leading-relaxed text-brand-ink-on-black-soft sm:mt-6 sm:text-lg">
            ...
            <div className="relative mt-4 aspect-[4/3] w-full lg:hidden">
              <Image
        ...
        <div className="mt-5 grid grid-cols-4 gap-2 sm:mt-16 sm:gap-6">
          {ICONS.map(({ icon: Icon, label }) => (
            <div key={label} className="flex flex-col items-center gap-1.5 text-center sm:gap-2.5">
              <Icon className="h-4 w-4 text-brand-accent sm:h-6 sm:w-6" strokeWidth={1.75} />
