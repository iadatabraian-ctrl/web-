...
export function AccesoDirecto() {
  return (
    <section id="directo" className="bg-brand-black px-5 py-20 sm:px-8 sm:py-28">
      <div className="mx-auto max-w-6xl">
        <FadeIn
          scale={0.95}
          className="crossmarks mx-auto max-w-3xl border border-brand-line-on-black px-6 py-14 text-center sm:px-16 sm:py-20"
        >
